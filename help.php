...
<body>
    ...
    <div class="container">
        <section class="overview">
            <h1>How to Use and Navigate This Website</h1>
            <h2>Home Page</h2>
                <ul>
                    <li>"Pocket Recipes" Logo: Redirects users to the home page from whichever page they are currently on.</li>
            ...
            <div class="case-study">
                <button onclick="window.location.href='case-study.php';">Case-Study</button>    
            </div>
        </section>
    </div>
